...
import classes from "../pagesStyles/Terms.module.css";
  ...
  return (
    <>
      ...
      <div className={classes.TermsContainer}>
        <h1 className={classes.Title}>Shipping Terms & Conditions</h1>
        <ul className={classes.TermsList}>
          ...
          <li className={classes.TermsItem}>
            8. Damaged or Lost Packages If your package arrives damaged, please
            contact us within 48 hours of delivery with photos of the damage
            and packaging. We will assist in filing a claim with the carrier and
            provide a replacement or refund. If your package is lost in transit,
            please contact us as soon as possible. We will work with the carrier
            to locate your package and, if necessary, issue a replacement or
            refund.
          </li>
          <li className={classes.TermsItem}>
